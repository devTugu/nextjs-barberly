...
import { DEFAULT_PLATFORM_LANDING, DEFAULT_TENANT_LANDING, type PlatformLandingContent, type TenantLandingContent } from '@/entities/tenant/types/landing-content';
